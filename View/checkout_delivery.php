...
$id = $_SESSION['id'];
$dinfo = getDeliveryInfoCtrlr($_SESSION['id']);
?>
                    ...
                    <h3>DELIVERY INFO</h3>
                        <form>
                            <form action="../Actions/get_orders_proc.php" method="post">
                                ...
                                <input type="text" name="fullname" id="fullname" value="<?php echo $dinfo['full_name']; ?>" readonly>
                                <br>
                                <label for="email">Email:</label>
                                <input type="text" name="email" id="email" value="<?php echo $dinfo['email']; ?>">
                                <br>
                                <label for="phnumber">Phone Number:</label>
                                <input type="text" name="phnumber" id="phnumber" value="<?php echo $dinfo['phone_number']; ?>" readonly>
                                <br>
                                <label for="ddt">Delivery Date & Time:</label>
                                <input type="datetime-local" name="ddt" id="ddt" value="<?php echo $dinfo['date_time']?>"readonly>
                                <br>
                                <label for="location">Location:</label>
                                <input type="text" name="location" id="location" value="<?php echo $dinfo['location']; ?>">
                                <br>
                    </div>
                </div>
            </div>
